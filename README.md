...
There's no custom Android app, but Ultima I runs well on Android through an existing DOSBox
...
3. Put your Ultima I game folder on the phone — the one with **`ULTIMA.EXE`** — or zip that folder.
...
2. New game → set the **`C:`** mount to your Ultima I folder and the run command to **`ULTIMA.EXE`**.
